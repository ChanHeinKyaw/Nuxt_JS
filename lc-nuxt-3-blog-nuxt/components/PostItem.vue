<template>
  <div class="post-container py-8">
    ...
    <div class="post-preview leading-relaxed mt-4">
      ...
      tempore aut cupiditate adipisci quisquam dolore numquam excepturi
      distinctio vero natus, aliquam ad eligendi, obcaecati accusamus? Eius
      deserunt alias quae earum, architecto nulla dolor similique ratione
      dignissimos aliquam esse totam?
    </div>
    <div class="mt-4">
      <NuxtLink
        :to="`/posts/1`"
